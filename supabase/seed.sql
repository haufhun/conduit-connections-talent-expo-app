...
BEGIN
  ...
  SET 
    ...
    city = 'San Francisco',
    state = 'CA',
    metadata = '{"bio": "Multi-talented musician and sound engineer with over 10 years of experience in the entertainment industry. Specializing in live performances and audio production."}'::jsonb
  WHERE id = user1_id;
