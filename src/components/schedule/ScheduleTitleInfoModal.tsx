...
interface ScheduleTitleInfoModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function ScheduleTitleInfoModal({
  isOpen,
  onClose,
}: ScheduleTitleInfoModalProps) {
  return (
              ...
              <HStack space="sm" className="items-start">
                ...
                <VStack space="xs" className="flex-1">
                  ...
                  <Text className="text-typography-600">
                    This title is for your personal organization only and will
                    not be shared with event organizers or other users.
                  </Text>
                </VStack>
              </HStack>
            </VStack>
